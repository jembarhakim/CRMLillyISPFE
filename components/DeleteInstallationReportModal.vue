  ...
  <UModal :model-value="isOpen" @update:model-value="$emit('update:isOpen', $event)" :ui="{ width: 'w-full sm:max-w-lg' }">
    <UCard>
      ...
      <div v-if="loading" class="text-center py-8">
        <UIcon name="i-heroicons-arrow-path" class="animate-spin text-2xl text-red-600 mx-auto mb-4" />
      ...
      <div v-else>
        ...
        <div class="bg-red-50 border border-red-200 rounded-lg p-5 mb-6">
          <div class="flex items-start">
            <UIcon name="i-heroicons-exclamation-triangle" class="text-red-500 text-xl mr-3 mt-0.5 flex-shrink-0" />
            <div>
        ...
        <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
          <h6 class="text-sm font-semibold text-gray-800 mb-3 flex items-center">
            <UIcon name="i-heroicons-information-circle" class="w-4 h-4 mr-2 text-gray-600" />
            Impact Summary
          </h6>
