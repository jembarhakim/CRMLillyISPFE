        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
          <div class="bg-blue-50 p-3 sm:p-4 rounded-lg">
            <div class="flex items-center">
              <UIcon name="i-heroicons-building-office" class="text-blue-600 text-xl sm:text-2xl mr-2 sm:mr-3" />
              <div>
          ...
          <div class="bg-green-50 p-3 sm:p-4 rounded-lg">
            <div class="flex items-center">
              <UIcon name="i-heroicons-check-circle" class="text-green-600 text-xl sm:text-2xl mr-2 sm:mr-3" />
              <div>
          ...
          <div class="bg-yellow-50 p-3 sm:p-4 rounded-lg">
            <div class="flex items-center">
              <UIcon name="i-heroicons-clock" class="text-yellow-600 text-xl sm:text-2xl mr-2 sm:mr-3" />
              <div>
          ...
          <div class="bg-purple-50 p-3 sm:p-4 rounded-lg">
            <div class="flex items-center">
              <UIcon name="i-heroicons-wrench-screwdriver" class="text-purple-600 text-xl sm:text-2xl mr-2 sm:mr-3" />
              <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div class="bg-gradient-to-br from-blue-500 to-blue-600 p-4 sm:p-6 rounded-lg text-white">
            <div class="flex items-center mb-3 sm:mb-4">
              <UIcon name="i-heroicons-document-plus" class="text-2xl sm:text-3xl mr-2 sm:mr-3" />
          ...
          <div class="bg-gradient-to-br from-green-500 to-green-600 p-4 sm:p-6 rounded-lg text-white">
            <div class="flex items-center mb-3 sm:mb-4">
              <UIcon name="i-heroicons-chart-bar" class="text-2xl sm:text-3xl mr-2 sm:mr-3" />
          ...
          <div class="bg-gradient-to-br from-orange-500 to-orange-600 p-4 sm:p-6 rounded-lg text-white">
            <div class="flex items-center mb-3 sm:mb-4">
              <UIcon name="i-heroicons-cube" class="text-2xl sm:text-3xl mr-2 sm:mr-3" />
          ...
          <div class="bg-gradient-to-br from-indigo-500 to-indigo-600 p-4 sm:p-6 rounded-lg text-white">
            <div class="flex items-center mb-3 sm:mb-4">
              <UIcon name="i-heroicons-users" class="text-2xl sm:text-3xl mr-2 sm:mr-3" />
          ...
          <div class="bg-gradient-to-br from-teal-500 to-teal-600 p-4 sm:p-6 rounded-lg text-white">
            <div class="flex items-center mb-3 sm:mb-4">
              <UIcon name="i-heroicons-wrench-screwdriver" class="text-2xl sm:text-3xl mr-2 sm:mr-3" />
        ...
        <div class="mt-6 sm:mt-8">
          ...
          <div class="bg-gray-50 rounded-lg p-3 sm:p-4">
            <div v-if="recentInstallations.length === 0" class="text-center py-6 sm:py-8 text-gray-500">
              <UIcon name="i-heroicons-document-text" class="text-3xl sm:text-4xl mb-2" />
