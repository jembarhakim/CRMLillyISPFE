          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="text-center">
              <div class="w-16 h-16 rounded-full mx-auto mb-4 flex items-center justify-center bg-gray-100">
                <UIcon name="i-heroicons-power" class="w-8 h-8 text-gray-600" />
              </div>
                ...
                <tr v-if="loading" class="text-center">
                  <td colspan="5" class="px-6 py-4">
                    <div class="flex items-center justify-center">
                      <UIcon name="i-heroicons-arrow-path" class="w-6 h-6 text-gray-400 animate-spin mr-2" />
          ...
          <div class="mb-6">
            <div class="h-64 bg-gray-50 rounded-lg flex items-center justify-center">
              ...
              <div v-else-if="connectionHistory.length === 0" class="text-center text-gray-500">
                <UIcon name="i-heroicons-chart-bar" class="w-8 h-8 mx-auto mb-2" />
