          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="text-center">
              <div class="w-16 h-16 rounded-full mx-auto mb-4 flex items-center justify-center bg-green-100">
                <LucideIcon name="check-circle" class="w-8 h-8 text-green-600" />
              </div>
            ...
            <div class="text-center">
              <div class="w-16 h-16 rounded-full mx-auto mb-4 flex items-center justify-center bg-red-100">
                <LucideIcon name="x-circle" class="w-8 h-8 text-red-600" />
              </div>
            ...
            <div class="text-center">
              <div class="w-16 h-16 rounded-full mx-auto mb-4 flex items-center justify-center bg-gray-100">
                <LucideIcon name="power" class="w-8 h-8 text-gray-600" />
              </div>
          ...
          <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
              ...
              <div class="relative">
                ...
                />
                <LucideIcon name="search" class="absolute left-3 top-2.5 w-4 h-4 text-gray-400" />
              </div>
                ...
                <tr v-if="loading" class="text-center">
                  <td colspan="5" class="px-6 py-4">
                    <div class="flex items-center justify-center">
                      <LucideIcon name="refresh-cw" class="w-6 h-6 text-gray-400 animate-spin mr-2" />
                    ...
                    <div class="flex items-center">
                      <div class="flex-shrink-0 h-10 w-10">
                        <div class="h-10 w-10 rounded-full bg-gray-300 flex items-center justify-center">
                          <LucideIcon name="user" class="w-5 h-5 text-gray-600" />
                        </div>
                      </div>
                      <div class="ml-4">
        ...
        <div class="p-6">
          ...
          <div class="mb-6">
            <div class="h-64 bg-gray-50 rounded-lg flex items-center justify-center">
              <div v-if="loading" class="text-center">
                <LucideIcon name="refresh-cw" class="w-8 h-8 text-gray-400 animate-spin mx-auto mb-2" />
                <p class="text-gray-500">Loading chart...</p>
              </div>
              <div v-else-if="connectionHistory.length === 0" class="text-center text-gray-500">
                <LucideIcon name="bar-chart" class="w-8 h-8 mx-auto mb-2" />
          ...
          <div class="max-h-64 overflow-y-auto border border-gray-200 rounded-lg">
            <div v-if="connectionHistory.length === 0" class="p-8 text-center text-gray-500">
              <LucideIcon name="info" class="w-8 h-8 mx-auto mb-2" />
